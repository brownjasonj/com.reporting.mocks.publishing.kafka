...
public class StartOfDayRiskResultSetProducer {
    private static final Logger LOGGER = Logger.getLogger( StartOfDayRiskResultSetProducer.class.getName() );
    ...
    public StartOfDayRiskResultSetProducer(IResultPublisherConfiguration resultsPublisherConfiguration, KafkaConfig appConfig) {
        this.TOPIC = resultsPublisherConfiguration.getStartOfDayRiskResultSetTopic();
