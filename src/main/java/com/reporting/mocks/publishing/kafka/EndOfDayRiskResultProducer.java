...
public class EndOfDayRiskResultProducer {
    private static final Logger LOGGER = Logger.getLogger( EndOfDayRiskResultProducer.class.getName() );
    ...
    public EndOfDayRiskResultProducer(IResultPublisherConfiguration resultsPublisherConfiguration, KafkaConfig appConfig) {
